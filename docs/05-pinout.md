...
| IR LED enable | GPIO47 | output | off | verificare driver, corrente e dissipazione |
...
| GPIO47 | GPIO generico | IR LED enable |
...
| --- | --- |
| GPIO0 | Boot strap |
| GPIO1-GPIO2 | ADC1, touch, LED_ON su GPIO2; evitare salvo necessita' |
...
- LED IR: assorbimento, driver, alimentazione e dissipazione.
- Storage: SD onboard su GPIO38-GPIO40 oppure FAT su flash.
- Uso di GPIO1/GPIO2: disponibili solo dopo verifica di LED_ON, ADC/touch e comportamento al boot.
